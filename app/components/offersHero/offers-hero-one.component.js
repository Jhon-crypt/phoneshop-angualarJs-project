            ...
            <div class="container my-5">
                ...
                style="background-color:#f99db2;">
                    ...
                    <div class="col-lg-4 p-0 overflow-hidden shadow-lg">
                        <img class="rounded-lg-3" src="public/images/image4.jpg" alt="" width="720">
                    </div>

                    <div class="col-lg-7 p-3 p-lg-5 pt-lg-3">

                        <h1 class="display-4 fw-bold lh-1 text-light">Awesome phone cases of all brands and sizes</h1>
                        <p class="lead">
